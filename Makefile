...
six: buffer.o comm.o common.o context.o df_pusher.o df_requester.o factory.o fp_json.o id.o idle_stopper.o jfp.o locator.o main.o mpi_comm.o mpi_comm_test.o printable.o remote_monitor.o rptr.o rts.o task.o tasks.o thread_pool.o thread_pool_test.o value.o
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -g -Og -Wall -Werror buffer.o comm.o common.o context.o df_pusher.o df_requester.o factory.o fp_json.o id.o idle_stopper.o jfp.o locator.o main.o mpi_comm.o mpi_comm_test.o printable.o remote_monitor.o rptr.o rts.o task.o tasks.o thread_pool.o thread_pool_test.o value.o -o six -I .
...
jfp.o: jfp.cpp ./jfp.h ./remote_monitor.h ./common.h ./thread_pool.h ./df_requester.h ./task.h ./buffer.h ./serializable.h ./rptr.h ./df_pusher.h ./json.h ./factory.h ./value.h ./buf_handler.h ./printable.h ./environ.h ./tasks.h ./stags.h ./context.h ./locator.h ./id.h ./comm.h
