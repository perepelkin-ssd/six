...
six: buffer.o comm.o common.o context.o df_pusher.o df_requester.o factory.o fp.o fp_json.o id.o idle_stopper.o jfp.o locator.o logger.o main.o mpi_comm.o mpi_comm_test.o printable.o remote_monitor.o rptr.o rts.o so_lib.o task.o tasks.o thread_pool.o thread_pool_test.o value.o ucenv/ucenv.o
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror buffer.o comm.o common.o context.o df_pusher.o df_requester.o factory.o fp.o fp_json.o id.o idle_stopper.o jfp.o locator.o logger.o main.o mpi_comm.o mpi_comm_test.o printable.o remote_monitor.o rptr.o rts.o so_lib.o task.o tasks.o thread_pool.o thread_pool_test.o value.o ucenv/ucenv.o -o six -I . /home/perepelkin/local/lib/libdyncall_s.a

buffer.o: buffer.cpp ./buffer.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o buffer.o buffer.cpp -I .

comm.o: comm.cpp ./printable.h ./buffer.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o comm.o comm.cpp -I .

common.o: common.cpp ./common.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o common.o common.cpp -I .

context.o: context.cpp ./printable.h ./common.h ./buffer.h ./serializable.h ./stags.h ./json.h ./context.h ./factory.h ./id.h ./value.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o context.o context.cpp -I .

df_pusher.o: df_pusher.cpp ./printable.h ./id.h ./buffer.h ./serializable.h ./thread_pool.h ./df_pusher.h ./json.h ./common.h ./value.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o df_pusher.o df_pusher.cpp -I .
...
df_requester.o: df_requester.cpp ./df_requester.h ./printable.h ./id.h ./buffer.h ./serializable.h ./thread_pool.h ./json.h ./common.h ./value.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o df_requester.o df_requester.cpp -I .
...
id.o: id.cpp ./printable.h ./id.h ./buffer.h ./common.h ./serializable.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o id.o id.cpp -I .

idle_stopper.o: idle_stopper.cpp ./idle_stopper.h ./common.h ./printable.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o idle_stopper.o idle_stopper.cpp -I .
...
jfp.o: jfp.cpp ./jfp.h ./remote_monitor.h ./common.h ./thread_pool.h ./df_requester.h ./task.h ./buffer.h ./serializable.h ./rptr.h ./df_pusher.h ./json.h ./factory.h ./value.h ./fp.h ./buf_handler.h ./printable.h ./environ.h ./code_lib.h ./tasks.h ./stags.h ./context.h ./locator.h ./id.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o jfp.o jfp.cpp -I .

locator.o: locator.cpp ./buffer.h ./serializable.h ./stags.h ./printable.h ./common.h ./locator.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o locator.o locator.cpp -I .

logger.o: logger.cpp ./logger.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o logger.o logger.cpp -I .
...
main.o: main.cpp ./idle_stopper.h ./jfp.h ./so_lib.h ./mpi_comm.h ./common.h ./rptr.h ./df_requester.h ./rts.h ./df_pusher.h ./buffer.h ./serializable.h ./thread_pool.h ./task.h ./json.h ./factory.h ./value.h ./code_lib.h ./buf_handler.h ./printable.h ./environ.h ./fp_json.h ./logger.h ./tasks.h ./stags.h ./context.h ./locator.h ./id.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o main.o main.cpp -I .

mpi_comm.o: mpi_comm.cpp ./buffer.h ./thread_pool.h ./mpi_comm.h ./printable.h ./common.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o mpi_comm.o mpi_comm.cpp -I .

mpi_comm_test.o: mpi_comm_test.cpp ./mpi_comm.h ./printable.h ./comm.h ./buffer.h ./thread_pool.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o mpi_comm_test.o mpi_comm_test.cpp -I .

printable.o: printable.cpp ./printable.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o printable.o printable.cpp -I .

remote_monitor.o: remote_monitor.cpp ./remote_monitor.h ./buf_handler.h ./common.h ./buffer.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o remote_monitor.o remote_monitor.cpp -I .

rptr.o: rptr.cpp ./buffer.h ./serializable.h ./rptr.h ./stags.h ./printable.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o rptr.o rptr.cpp -I .
...
rts.o: rts.cpp ./idle_stopper.h ./df_requester.h ./code_lib.h ./common.h ./rptr.h ./rts.h ./task.h ./buffer.h ./serializable.h ./thread_pool.h ./df_pusher.h ./json.h ./factory.h ./value.h ./buf_handler.h ./printable.h ./environ.h ./logger.h ./stags.h ./id.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o rts.o rts.cpp -I .

so_lib.o: so_lib.cpp ./so_lib.h ./code_lib.h ./printable.h ./common.h ./ucenv/ucenv.h ./buffer.h ./serializable.h ./json.h ./id.h ./value.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o so_lib.o so_lib.cpp -I .
...
task.o: task.cpp ./df_requester.h ./code_lib.h ./common.h ./thread_pool.h ./task.h ./buffer.h ./serializable.h ./rptr.h ./df_pusher.h ./json.h ./value.h ./buf_handler.h ./printable.h ./environ.h ./id.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o task.o task.cpp -I .
...
tasks.o: tasks.cpp ./df_requester.h ./code_lib.h ./common.h ./rptr.h ./df_pusher.h ./buffer.h ./serializable.h ./thread_pool.h ./task.h ./json.h ./factory.h ./value.h ./buf_handler.h ./printable.h ./environ.h ./tasks.h ./stags.h ./locator.h ./id.h ./comm.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o tasks.o tasks.cpp -I .

thread_pool.o: thread_pool.cpp ./printable.h ./thread_pool.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o thread_pool.o thread_pool.cpp -I .

thread_pool_test.o: thread_pool_test.cpp ./printable.h ./thread_pool.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o thread_pool_test.o thread_pool_test.cpp -I .

value.o: value.cpp ./printable.h ./id.h ./buffer.h ./serializable.h ./stags.h ./json.h ./common.h ./value.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o value.o value.cpp -I .

ucenv/ucenv.o: ucenv/ucenv.cpp ./ucenv/ucenv.h
	MPICH_CXX=g++5 /home/perepelkin/local/bin/mpicxx -std=c++11 -lpthread -ldl -ldyncall_s -g -Og -Wall -Werror -c -o ucenv/ucenv.o ucenv/ucenv.cpp -I .
